  ...
  return (
    <Box sx={{ flexGrow: 2}} >
	  ...
	  <ThemeProvider theme={theme}>	
	  	<Typography variant="body2" gutterBottom>Search for specific salivary proteins found in our database.</Typography>
	  </ThemeProvider>
	  <Divider sx={{pb: 2}}/>
        ...
        <Grid xs={2} md={2.1}display="flex">
          <Item>
            ...
            <ThemeProvider theme={theme}>
	   	<Typography variant = "body2" gutterBottom>Evaluate proteins, quantify abundance and perform statistics.</Typography>
            </ThemeProvider>
	    <Divider sx={{pb: 2}}/>
        ...
        <Grid xs={2} md={2.1}display="flex">
          <Item>
            ...
            <ThemeProvider theme={theme}>
	    	<Typography variant="body2" gutterBottom>Upload experiment to the database. Files have to be in mzTab format.</Typography>
            </ThemeProvider>
	    <Divider sx={{pb: 2}}/>
        ...
        <Grid xs={2} md={2.1}display="flex">
          <Item>
            ...
            <ThemeProvider theme={theme}>
	     	<Typography variant="body2" gutterBottom>Download datasets from database with protein abundance and sequence.</Typography>
            </ThemeProvider>
	    <Divider sx={{pb: 2}}/>
        ...
        <Grid display="flex" sx={{ml:4}}>
          <Item>
	    <ThemeProvider theme={theme}>
            	<Typography variant="body2" color="common.black" sx={{mt:'10%'}}>7 Contributing Institutions</Typography>
            	<Typography variant="body2" color="common.black">7 Studies </Typography>
            	<Typography variant="body2" color="common.black">946 Datasets </Typography>
            	<Typography variant="body2" color="common.black">5 Tissue Types </Typography>
            	<Typography variant="body2" color="common.black">3 Diseases + Healthy Controls</Typography>
           </ThemeProvider>
	  <Divider sx={{pb: 2}}/>
	  <ThemeProvider theme={theme}>
	  	<Typography variant="h6" gutterBottom sx={{mb:"50",mt:"10%"}}>Statistics</Typography>
	  </ThemeProvider>
	  </Item>
        </Grid>
      </Grid>
      <Grid container direction='row' spacing={1} p={2} display="flex">
        <Grid xs={2} md={2.1} display="flex">
          <Item>
            ...
            <ThemeProvider theme={theme}>
	    	<Typography variant="body2" gutterBottom>Includes links to full text articles and other related resources.</Typography>
            </ThemeProvider>
	    <Divider sx={{pb: 2}}/>
        ...
        <Grid xs={2} md={2.1}display="flex">
          <Item>
            ...
            <ThemeProvider theme={theme}>
	    	<Typography variant = "body2" gutterBottom>A locatable region of genomic sequence, corresponding to a unit of inheritance.</Typography>
            </ThemeProvider>
	    <Divider sx={{pb:2}}/>
        ...
        <Grid xs={2} md={2.1}display="flex">
          <Item>
            ...
            <ThemeProvider theme={theme}>
	    	<Typography variant="body2" gutterBottom>Search clusters that share one or more common proteins are merged further.</Typography>
            </ThemeProvider>
	    <Divider sx={{pb:2}}/>
        ...
        <Grid xs={2} md={2.1}display="flex">
          <Item>
            ...
            <ThemeProvider theme={theme}>
	    	<Typography variant="body2" gutterBottom>Allows access to the datasets by retrieving requested data in JSON.</Typography>
            </ThemeProvider>
	    <Divider sx={{pb:2}}/>
